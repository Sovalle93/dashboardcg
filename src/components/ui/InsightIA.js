    ...
    <div className="card">
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <p style={{ fontSize: 13, fontWeight: 700, color: "#111" }}>Análisis con IA ⚡</p>
            <p style={{ fontSize: 11, color: "#999", marginTop: 1 }}>Groq · Llama 3 · Rápido y preciso</p>
          </div>
        </div>
        <button
        ...
        <div style={{ marginTop: 20 }}>
          ...
          {metadata && (
            <div style={{
              ...
              <CheckCircle size={12} />
              {metadata.model && <span>Modelo: {metadata.model}</span>}
              ...
              {metadata.generatedAt && (
                <span>Generado: {new Date(metadata.generatedAt).toLocaleTimeString()}</span>
              )}
            </div>
          )}
        </div>
